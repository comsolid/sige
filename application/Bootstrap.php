...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
    public function _initRoutes()
    {
        ...
        $route = new Zend_Controller_Router_Route_Static('/inscricoes', array(
            'module' => 'admin',
        ...
        $route = new Zend_Controller_Router_Route_Static('/pre-inscricao', array(
            'module' => 'admin',
            'controller' => 'participante',
            'action' => 'pre-inscricao',
        ));
        $router->addRoute('pre-inscricao', $route);

        $route = new Zend_Controller_Router_Route_Static('/admin', array(
            'module' => 'admin',
        ...
        $route = new Zend_Controller_Router_Route_Static('/sobre', array(
            'controller' => 'index',
            'action' => 'sobre',
        ));
        $router->addRoute('sobre', $route);

        $route = new Zend_Controller_Router_Route_Static('/submissao', array(
            'controller' => 'evento',
            'action' => 'index',
        ));
        $router->addRoute('submissao', $route);

        $route = new Zend_Controller_Router_Route_Static('/participar', array(
            'controller' => 'participante',
            'action' => 'criar',
        ));
        $router->addRoute('participar', $route);

        $route = new Zend_Controller_Router_Route_Static('/recuperar-senha', array(
            'controller' => 'index',
            'action' => 'recuperar-senha',
        ));
        $router->addRoute('recuperar-senha', $route);

        $route = new Zend_Controller_Router_Route('/u/:id', array(
            'controller' => 'participante',
            'action' => 'ver',
        ));
        $router->addRoute('ver', $route);

        $route = new Zend_Controller_Router_Route('/mobile/u/:id', array(
            'module' => 'mobile',
            'controller' => 'participante',
            'action' => 'ver',
        ));
        ...
        $route = new Zend_Controller_Router_Route('/u/confirmar/:id', array(
            'module' => 'admin',
            'controller' => 'participante',
            'action' => 'presenca',
            'confirmar' => 't',
        ...
        $route = new Zend_Controller_Router_Route('/u/desfazer-confirmar/:id', array(
            'module' => 'admin',
            'controller' => 'participante',
            'action' => 'presenca',
            'confirmar' => 'f',
        ));
        $router->addRoute('desfazer_confirmar_participante', $route);

        $route = new Zend_Controller_Router_Route('/u/inscrever-confirmar/:id', array(
            'module' => 'admin',
            'controller' => 'participante',
            'action' => 'presenca',
        ));
        $router->addRoute('inscrever_confirmar_participante', $route);

        $route = new Zend_Controller_Router_Route('/admin/evento/validar/:id', array(
            'module' => 'admin',
            'controller' => 'evento',
            'action' => 'situacao',
            'validar' => 't',
        ...
        $route = new Zend_Controller_Router_Route('/admin/evento/invalidar/:id', array(
           'module' => 'admin',
           'controller' => 'evento',
           'action' => 'situacao',
           'validar' => 'f',
        ...
        $route = new Zend_Controller_Router_Route('/admin/evento/apresentado/:id', array(
           'module' => 'admin',
           'controller' => 'evento',
        ...
        $route = new Zend_Controller_Router_Route('/admin/evento/desfazer-apresentado/:id', array(
           'module' => 'admin',
           'controller' => 'evento',
           'action' => 'situacao-pos-evento',
           'apresentado' => 'f',
        ...
        $route = new Zend_Controller_Router_Route('/admin/evento/outros-palestrantes/confirmar/:pessoa/:evento', array(
           'module' => 'admin',
           'controller' => 'evento',
        ...
        $route = new Zend_Controller_Router_Route('/admin/evento/outros-palestrantes/desfazer/:pessoa/:evento', array(
           'module' => 'admin',
           'controller' => 'evento',
           'action' => 'outros-palestrantes',
           'confirmar' => 'f',
        ...
        $route = new Zend_Controller_Router_Route_Static('/programacao', array(
            'controller' => 'evento',
            'action' => 'programacao',
        ));
        $router->addRoute('programacao', $route);

        $route = new Zend_Controller_Router_Route('/c/validar/:id', array(
            'module' => 'admin',
            'controller' => 'caravana',
            'action' => 'situacao',
            'validar' => 't',
        ...
        $route = new Zend_Controller_Router_Route('/c/invalidar/:id', array(
            'module' => 'admin',
            'controller' => 'caravana',
            'action' => 'situacao',
            'validar' => 'f',
        ...
        $route = new Zend_Controller_Router_Route('/e/:id', array(
            'controller' => 'evento',
            'action' => 'ver',
        ));
        $router->addRoute('ver_evento', $route);

        $route = new Zend_Controller_Router_Route('/mobile/e/:id', array(
            'module' => 'mobile',
            'controller' => 'evento',
            'action' => 'ver',
        ));
        ...
        $route = new Zend_Controller_Router_Route_Static('/mobile', array(
            'module' => 'mobile',
            'controller' => 'participante',
            'action' => 'index',
        ));
