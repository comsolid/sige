...
class Admin_Model_Pessoa extends Application_Model_Pessoa {
    ...
    public function ajaxBuscarEmail($termo, $id_pessoa, $id_encontro, $id_evento_realizacao) {
        ...
        return $this->getAdapter()->fetchAll($sql, array("%{$termo}%", $id_pessoa, $id_encontro, $id_evento_realizacao));
    }
}
